...
#SBATCH --job-name=run_usps
#SBATCH --account=qingqu1
#SBATCH --partition=gpu
#SBATCH --gpus=1
#SBATCH --ntasks-per-gpu=1
#SBATCH --mem-per-gpu=4G
#SBATCH --output=./logs/run_usps.log
...
do
	...
	do
		...
		MODEL_PATH="${SAVE_DIR}/width_${WIDTH}_depth_${DEPTH}_nonlinear_depth_${NONLINEAR_DEPTH}_${INIT}_init_${DATA_TYPE}_data_dim_${DATA_DIM}_${NUM_CLASSES}_classes_${ACTIVATION}_activation_seed_${SEED}"

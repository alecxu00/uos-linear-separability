...
#SBATCH --job-name=run_angles
#SBATCH --account=qingqu1
#SBATCH --partition=gpu
#SBATCH --gpus=1
#SBATCH --ntasks-per-gpu=1
#SBATCH --output=../logs/run_angles.log

# sweep through network widths and activation functions
declare -a widths=(16 32 48 64 80 96 112 128) # 256 512 1024 2048)
declare -a angles=(15 30 45 60 75 90)

...
#SBATCH --job-name=run_fashion_mnist
...
#SBATCH --output=../logs/fashion_mnist/run_fashion_mnist_leaky_relu.log
...
SAVE_DIR="/scratch/qingqu_root/qingqu1/alecx/uos-lin-sep-results/fashion_mnist/"
NUM_TRIALS=5
